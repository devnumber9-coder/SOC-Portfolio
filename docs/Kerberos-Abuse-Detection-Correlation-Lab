# Kerberos Abuse Detection & Correlation Lab

## Objective

Detect and analyze suspicious Kerberos authentication activity in an Active Directory environment using Windows Security Event Logs and correlation methodology.  
The focus is on defensive analysis rather than exploitation, emphasizing context, correlation,and documentation.
...
These findings reinforce the need for identity-aware, context-driven detection strategies.
...
- High-quality documentation and clear analytic reasoning are essential for workflows and incident handoffs.
